...
Aplot <- ggplot(data = distribs, aes(value)) + 
	...
	facet_wrap(~factor(variable, 
			   levels = c('bimodal', 'gaussian', 'uniform', 'bimodal_50', 'bimodal_90', 'bimodal_10'),
...
#### +++++++ WITH RECRUITMENT +++++++ ####
#### BIMODAL 10/90 ####
path_bimodal_10 <- '/home/polfer/research/gits/AutomatAnts/results/without_food/parameters/bimodal_10/'
...
#### BIMODAL 90/10 ####
path_bimodal_90 <- '/home/polfer/research/gits/AutomatAnts/results/without_food/parameters/bimodal_90/'
...
#### BIMODAL 50/50 ####
path_bimodal_50 <- '/home/polfer/research/gits/AutomatAnts/results/without_food/parameters/bimodal_50/'
...
#### BIMODAL ####
path_bimodal <- '/home/polfer/research/gits/AutomatAnts/results/without_food/parameters/bimodal/'
...
#### GAUSSIAN-LIKE ####
path_gaussian <- '/home/polfer/research/gits/AutomatAnts/results/without_food/parameters/gaussian/'
...
#### UNIFORM + RECRUITMENT ####
path_uniform <- '/home/polfer/research/gits/AutomatAnts/results/without_food/parameters/uniform/'
...
Bplot <- ggarrange(plot_clusters(bimodal, kBimodal),
		   plot_clusters(gaussian, kGaussian),
		   plot_clusters(uniform, kUniform),
		   plot_clusters(bimodal_90, kBimodal_50),
		   plot_clusters(bimodal_10, kBimodal_90), 
		   plot_clusters(bimodal_10, kBimodal_10), nrow = 6, ncol = 1)


png('~/research/gits/AnTracks/plots/PLOTS_PROPORTIONS_NF.png', width = 8000, height = 10000, res = 450)
...
png('~/research/gits/AnTracks/plots/PLOTS_PROPORTIONS_NF_noUniform.png', width = 8000, height = 8000, res = 450)
ggarrange(Aplot, Bplot, widths = c(1/4, 3/4), labels = c('A', 'B'),
	  font.label = list(size = 18, face = 'plain'))
dev.off()
