...
# path <- '/home/polfer/research/gits/AutomatAnts/results/2024/scenarios/J_0/'
# files <- list.files(path)
# files <- unique(unlist(regmatches(files, gregexpr('J_0_\\d{1,2}', files))))

# path <- '/home/polfer/research/gits/AutomatAnts/results/2024/scenarios/J11_0/'
# files <- list.files(path)
# files <- unique(unlist(regmatches(files, gregexpr('J11_0_\\d{1,2}', files))))

# path <- '/home/polfer/research/gits/AutomatAnts/results/2024/scenarios/J_0.01/'
# files <- list.files(path)
# files <- unique(unlist(regmatches(files, gregexpr('J_0.01_\\d{1,2}', files))))

path <- '/home/polfer/research/gits/AutomatAnts/results/2024/scenarios/J00_1/'
files <- list.files(path)
files <- unique(unlist(regmatches(files, gregexpr('J00_1_\\d{1,2}', files))))
